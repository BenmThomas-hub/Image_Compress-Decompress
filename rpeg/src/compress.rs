...
// Reads the ppm input and converts it into an RGB image
...
// Converts RBG integer pixels into RGB floats
...
// Shifts the intended coefficients' bitwise counterparts to store as a 32-bit word
